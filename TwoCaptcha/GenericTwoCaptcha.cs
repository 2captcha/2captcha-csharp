...
{
    public class GenericTwoCaptcha
    {
        /**
         * API KEY
         */
         ...
         * @param apiKey
         */
        public GenericTwoCaptcha(string apiKey) : this()
        {
            ApiKey = apiKey;
        }

        public GenericTwoCaptcha(string apiKey, int extendedResponse) : this()
        {
            ApiKey = apiKey;
         ...
         * @throws Exception
         */
        public async Task Solve(Captcha.GenericCaptcha captcha)
        {
         ...
         * @throws Exception
         */
        public async Task Solve(Captcha.GenericCaptcha captcha, Dictionary<string, int> waitOptions)
        {
         ...
         * @throws Exception
         */
        public async Task WaitForResult(Captcha.GenericCaptcha captcha, Dictionary<string, int> waitOptions)
        {
         ...
         * @throws Exception
         */
        public async Task<string> Send(Captcha.GenericCaptcha captcha)
        {
